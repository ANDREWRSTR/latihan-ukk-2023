...
<body>
  ...
  <div class="container">
    ...
    <div class="isi">
        <div class="kotak">
            <form action={{url ("/update_produk/$produk->ProdukID")}} method="post">
              @method('POST')
              @csrf
              <h1>Update Produk</h1>
              <label>Nama Produk</label><br>
              <input type="text" name="barang" value="{{$produk->NamaProduk}}"><br>
              <label>Harga</label><br>
              <input type="text" name="harga" value="{{$produk->Harga}}"><br>
              <label>Stok</label> <br>
              <input type="text" name="stok" value="{{$produk->Stok}}"><br>
